...
--
-- Host: localhost
-- Generation Time: Jun 26, 2018 at 06:37 PM
...
CREATE TABLE IF NOT EXISTS `tbl_beli_suplier` (
...
CREATE TABLE IF NOT EXISTS `tbl_pembeli` (
  ...
  `no_faktur` int(11) NOT NULL AUTO_INCREMENT,
...
--
CREATE TABLE IF NOT EXISTS `v_laba` (
...
--
CREATE TABLE IF NOT EXISTS `v_transaksi_detail` (
`jumlah_uang` double
,`total_belanja` double
,`uang_kembali` double
,`detail` int(11)
...
--
CREATE TABLE IF NOT EXISTS `v_transaksi_laporan_penjualan` (
`nama_kategori` varchar(15)
,`tanggal_beli` timestamp
,`jumlah_uang` double
,`total_belanja` double
